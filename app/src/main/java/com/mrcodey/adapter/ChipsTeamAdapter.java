 ...
 */
public class ChipsTeamAdapter extends BaseAdapter
{
    ...
    public ChipsTeamAdapter(Context context, List list)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = LayoutInflater.from(mContext).inflate(
                    R.layout.team_list, parent, false);
    ...
    public void displayImg(final View view,String url,RequestQueue mRequestQueue){
        ...
        imageLoader.get(url, new ImageLoader.ImageListener()
        {
            ...
            public void onResponse(ImageLoader.ImageContainer request, boolean b)
            {
                ...
                {
                    ((ImageView) view).setImageResource(R.drawable.head);//默认图片
                }
            }
